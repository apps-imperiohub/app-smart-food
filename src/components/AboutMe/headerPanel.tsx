...
const HeaderAboutMe = ({ nombre, gmail, img, pais }: AboutMeProps) => {
    return (
        <View style={styles.header}>
            <View style={{ display: "flex", flexDirection: "row", alignItems: "center", gap: 10 }}>
                <Image 
                    source={{ uri: img || "https://avatars.githubusercontent.com/u/52204213?v=4" }}  
                    alt="User" 
                    style={styles.img}
                />
                <View>
                    <Text style={favoritesStyles.title}>{nombre || "Registrate"}</Text>
                    <Text style={styles.subtitle}>{gmail || "No gmail"}</Text>
                </View>
            </View>
            <View style={{ display: "flex", flexDirection: "row", alignItems: "center", gap: 10 }}>
                <Image 
                    ...
                    style={styles.img}
                />
                <Svg width={50} height={50} viewBox="0 -960 960 960" >
                    <Path 
